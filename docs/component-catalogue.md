...
The 0.2.0 candidate expands Product UI into reusable controls, data displays and complete patterns. Use the component's Storybook documentation for props and live states. Components use the same generated tokens as the foundations reference.
