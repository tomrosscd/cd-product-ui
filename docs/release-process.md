...
2. Run pnpm test:dark, pnpm check, pnpm format:check and pnpm package:check and pnpm next:check. Inspect desktop, 390px mobile and long-content states. Check keyboard focus, mobile Escape/focus return, error recovery and reduced motion. Use the Convert rules and Impeccable review guidance.
