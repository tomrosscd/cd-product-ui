...
These instructions apply to this repository. The package version is authoritative; see package.json and CHANGELOG.md. The user-approved Convert product system is authoritative.
